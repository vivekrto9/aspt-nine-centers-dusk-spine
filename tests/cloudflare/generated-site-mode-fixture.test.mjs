...
test("generated-site workflow and runtime contracts pass without template-only files", () => {
  ...
  writeFileSync(
    ...
    [
      ...
      "      - run: pnpm exec wrangler deploy --env preview --config .wrangler/generated/wrangler.preview.jsonc --secrets-file \"$RUNNER_TEMP/aspt-nine-centers-dusk-spine-worker-secrets.json\"",
  ...
  writeFileSync(
    ...
    [
      ...
      "      - run: pnpm exec wrangler deploy --env production --config .wrangler/generated/wrangler.production.jsonc --secrets-file \"$RUNNER_TEMP/aspt-nine-centers-dusk-spine-worker-secrets.json\"",
