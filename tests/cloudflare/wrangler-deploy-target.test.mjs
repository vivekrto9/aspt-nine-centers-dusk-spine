...
const config = {
  d1_databases: [
    { binding: "DB", database_name: "aspt-nine-centers-dusk-spine-site" },
  ],
  env: {
    preview: {
      d1_databases: [
        { binding: "DB", database_name: "aspt-nine-centers-dusk-spine-preview-site" },
      ],
    },
    production: {
      d1_databases: [
        { binding: "DB", database_name: "aspt-nine-centers-dusk-spine-production-site" },
      ],
    },
  },
};
...
test("selects the D1 database from the requested deployment environment", () => {
  assert.equal(
    ...
    "aspt-nine-centers-dusk-spine-preview-site",
  );
  assert.equal(
    databaseNameForEnvironment(config, "production"),
    "aspt-nine-centers-dusk-spine-production-site",
  );
});
