...
test("repository docs describe Nine Centres Dusk Spine without stale single-page or legacy catalog guidance", () => {
  ...
  assert.doesNotMatch(publicDocs, /templates\/aspt-nine-centers-dusk-spine\/0\.1\.0\//);
...
test("lead documentation is an agent-ready integration reference", () => {
  ...
  assert.match(docs.leads, /wrangler d1 execute aspt-nine-centers-dusk-spine-site --local/);
